...
\begin{enumerate}
          ...
          \begin{center}
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \draw[green, ->] (2, 1) -- ++(0.5, 0.5) node[above right, scale=0.75] {$\nabla f(x_*, y_*, \mu_*)$};
                      \draw[blue, ->] (2, 1) -- ++(-0.5, 0.5) node[above left, scale=0.75] {$\nabla g(x_*, y_*, \mu_*)$};

                      \draw[blue] (2, 1) -- ++(-1, -0.5);
                      \draw[blue] (2, 1) -- ++(1, 0.5) node[below right, scale=0.75] {nullcline g};

                      \draw[green] (2, 1) -- ++(1, -0.5) node[right, scale=0.75] {nullcline f};
                      \draw[green] (2, 1) -- ++(-1, 0.5);
    ...
    \item $\nabla f(x_*, y_*, \mu_*)$ and $\nabla g(x_*, y_*, \mu_*)$ are nonzero and linearly dependent.
          ...
          \begin{center}
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \draw[green, ->] (2, 1) -- ++(0, 0.5) node[above, scale=0.75] {$\nabla f(x_*, y_*, \mu_*)$};
                      \draw[blue, ->] (2, 1) -- ++(0, -0.5) node[above left, scale=0.75] {$\nabla g(x_*, y_*, \mu_*)$};

                      \addplot[green] {1/4*(x-2)^2 + 1} node[below right, scale=0.75] {nullcline f};
          ...
          where the nullclines must be tangenst to each other.
          ...
          \begin{center}
              ...
              \begin{tikzpicture}
                  \begin{axis}[
                      ...
                      \addplot[green, name path=g] {1/4*(x-2)^2 + 0.7};
...
\begin{tbox}{\textbf{Lemma:} Let $(x_*, y_*)$ be an equiibrium of $\begin{pmatrix}
                \dot x \\ \dot y
            \end{pmatrix}= \begin{pmatrix}
                f(x, y, \mu) \\ g(x, y, \mu)
...
\begin{center}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[name path=y0, green] {4/(1 + e^(4-x)) - 0.07} node[right] {nullcline $g$};
